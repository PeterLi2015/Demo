...
function save(vm) {
    ...
    var data = {
        ...
        Product: {
            ...
            Product8Quantity: vm.product.product8Quantity == '' ? 0 : parseInt(vm.product.product7Quantity),
            Product9Quantity: vm.product.product9Quantity == '' ? 0 : parseInt(vm.product.product7Quantity)
        }
    }
    showDialog('正在注册，请稍后...');
